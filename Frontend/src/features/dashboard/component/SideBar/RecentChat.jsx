...
export const RecentChats = ({ chats = [] }) => {
  ...
  return (
    ...
    <div className="flex-1 overflow-y-auto flex flex-col px-4 mt-2 mb-4">
      ...
      <div className="flex flex-col gap-0.5">
        {chats.map((chat) => (
          ...
          >
            <MessageSquare size={16} className="text-slate-400 group-hover:text-blue-500 shrink-0 transition-colors" />
